...
@description('''Array of files to be ran while the Virtual Machine is being created.
Example: 
[
    https://example.com/scripts/file1.ps1,
    https://example.com/scripts/file2.ps1
]
''')
...
resource virtualMachine_CustomScriptExtension 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = {
  ...
  properties: {
    ...
    autoUpgradeMinorVersion: true
    settings: {
      fileUris: virtualMachine_ScriptFiles
    }
    protectedSettings: {
