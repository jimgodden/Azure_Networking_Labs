...
param tagValues object = {
  Training: 'PrivateDNSZone-Complete'
}
...
// Updates the Virtual Network with the Hub_WinDnsVm's IP Address as the default DNS Server
module Hub_VirtualNetwork_DNSUpdate '../../modules/Microsoft.Network/VirtualNetwork.bicep' = {
  name: 'Hub_VirtualNetwork_DNSUpdate'
  params: {
    virtualNetwork_AddressPrefix: '10.0.0.0/16'
    dnsServers: [ Hub_WinDnsVm.outputs.networkInterface_PrivateIPAddress ]
    location: location
    virtualNetwork_Name: 'Hub_VNet'
    tagValues: tagValues
  }
