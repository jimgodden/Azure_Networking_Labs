...
function Install-WinGetPackage {
    ...
    winget install --scope machine $PackageName --accept-source-agreements
}
...
# winget install --scope machine wireshark
# winget install --scope machine vscode
# winget install --scope machine pstools
