...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/jimgodden/Azure_Networking_Labs/buildtest/scripts/WinServ2022_InstallTools.ps1" -OutFile "c:\installTools.ps1"
