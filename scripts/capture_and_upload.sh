...
while true; do
    ...
    sudo tcpdump -w $output_file_path host $destinationIPAddress -s 120 -K -n &
    ...
    python3 $local_folder_path/upload_to_blob.py --account-name $storage_account_name --account-key $storage_account_key --container-name $container_name --local-file-path $local_folder_path  --blob-name $output_file_path
